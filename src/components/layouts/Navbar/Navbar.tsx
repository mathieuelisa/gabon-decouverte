								...
								{activePanel === 'activité' ? (
									<>
										<div className='flex w-[30%] flex-col gap-14 px-4 sup-md:px-12 py-4'>
											...
											<Link
												className='flex cursor-pointer justify-center rounded-sm bg-greeny-100 p-3 font-caviarDreams-bold sup-lg::text-base text-sm text-white uppercase transition-all duration-400 ease-in-out hover:bg-greeny-50'
												href={{
													pathname: '/activite',
